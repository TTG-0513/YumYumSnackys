...
import 'package:yumyumsnackys/Danksch%C3%B6n/thank_you_for_order.dart';
...
void main() {
  runApp(DetailScreenLarge());
}

class DetailScreenLarge extends StatelessWidget {
  const DetailScreenLarge({super.key});
                ...
                child: TextButton(
                  onPressed: () {
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => DetailScreenMedium()));
                  },
                  style: ButtonStyle(),
                  child: Center(
                      child: Text(
